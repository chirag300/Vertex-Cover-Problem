...
BFS Implementation learnt and referenced by "Intro to algorithms" and "GEEKS FOR GEEKS" web [Line Number: 68]
sstream referenced from the sir's code of calc.cpp given in the gitlab [Line Number: 139]
regex method condition referred from stackoverflow [Line Number: 168]
